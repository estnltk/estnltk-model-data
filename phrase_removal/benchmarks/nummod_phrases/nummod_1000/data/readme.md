...
* `nummod_benchmark_1000.csv`: contains 1000 sentences with manual labeling.

* `nummod_benchmark_1000_original.conllu`: contains the original syntax for the 1000 sentences. In the conllu file benchmark_id refers to the column id in the benchmark_1000.csv file.
