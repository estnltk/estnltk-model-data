#
#  Aggregates train/*_original.conllu and dev/*_original.conllu files 
#  into original_sentences_train.conllu and original_sentences_dev.conllu 
#  files.
#
#  Note: original_sentences_*.conllu files will be using different 
#  morphological tagsets than cut_sentences_*.conllu files. 
#  It remains a future work to unify the tagsets. 
#
...
cut_file_suffix = '_original.conllu'
dirs = ['Train', 'Dev']
...
for d in dirs:
    ...
    if dir_conllu_content:
        ...
        out_fname = f'original_sentences_{dir_name.lower()}.conllu'
